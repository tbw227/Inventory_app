...
import { formatCurrency, revenuePeriodLabel } from '../../utils/formatCurrency'
...
function formatRevenueDisplay(value, loading) {
    ...
    >
      ...
      <div className="relative px-6 py-8 sm:px-10 sm:py-10">
        ...
        <section className="relative mt-10">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            {onRevenueDaysChange ? (
              ...
              <div className="flex flex-col gap-1 sm:items-end">
                ...
                <label htmlFor="profile-revenue-period" className="sr-only">
                ...
                <select
                  ...
                  id="profile-revenue-period"

                  value={revenueDays ?? '30'}

                  onChange={(e) => onRevenueDaysChange(e.target.value)}

                  className="rounded-lg border border-slate-200/90 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 shadow-sm focus:border-teal-500/50 focus:outline-none focus:ring-2 focus:ring-teal-500/20 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200"
                ...
                <p className="text-[10px] text-slate-400 dark:text-slate-500">
                  ...
                  {revenuePeriodLabel(revenueDays === 'all' ? null : Number(revenueDays))}
          ...
          {(onRevenueDaysChange || shopRevenue !== null || techRevenue !== null) && (
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              ...
              <MetaTile
                ...
                value={formatRevenueDisplay(shopRevenue, revenueLoading)}
              ...
              <MetaTile
                ...
                value={formatRevenueDisplay(techRevenue, revenueLoading)}
